...
void onTick(CBlob@ this)
{
	if (!this.hasTag("dead"))
	{
		...
		if (netid != 0)
		{
			...
			if (blob !is null && !blob.hasTag("dead") && blob.getName() != "exosuit")
			{
				succ = true;
...
{
	if (blob !is null && getGameTime() >= this.get_u32("next attach") && this.get_u16("succ netid") == 0 && blob.hasTag("human") && !blob.hasTag("dead") && !this.hasTag("dead") && blob.getName() != "hazmat" && !blob.hasTag("sanctfied"))
	{
