...
void addCommonBuilderBlocks(BuildBlock[][]@ blocks, int teamnum = 7)
{
	...
	AddIconToken("$icon_plasteelrextractor$", "PlasteelExtractorR_icon.png", Vec2f(24, 48), 0);
	AddIconToken("$icon_plasteelfurnace$", "PlasteelFurnace.png", Vec2f(36, 31), 0);
	AddIconToken("$icon_plasteelgrinder$", "PlasteelGrinder.png", Vec2f(40, 24), 0);
	AddIconToken("$icon_plasteeltreecapitator$", "PlasteelTreecapitator.png", Vec2f(24, 8), 0);
	AddIconToken("$icon_1x5plasteelblastdoor$", "1x5PlasteelBlastDoor.png", Vec2f(8, 40), 0, teamnum);
	...
	{
		BuildBlock b(0, "plasteeltreecapitator", "$icon_plasteeltreecapitator$", "Plasteel Treecapitator:\n\nChops plants and trees. Doesn't break if spammed in close area, like common treecapitator do.");
		AddRequirement(b.reqs, "blob", "mat_wood", "Wood", 250);
		AddRequirement(b.reqs, "blob", "mat_ironingot", "Iron ingot", 8);
		blocks[2].push_back(b);
	}
	{
		BuildBlock b(0, "plasteelfurnace", "$icon_plasteelfurnace$", "Plasteel Furnace:\n\nA giant monstrosity which is powered by nanomachines. Can melt mithril.");
		AddRequirement(b.reqs, "blob", "mat_mithrilingot", "Mithril Ingot", 100);
		AddRequirement(b.reqs, "blob", "mat_matter", "Amazing Technicolor Dust", 300);
		AddRequirement(b.reqs, "blob", "mat_wilmetingot", "Wilmet Ingot", 60);
		AddRequirement(b.reqs, "blob", "mat_plasteel", "Plasteel Sheet", 400);
		AddRequirement(b.reqs, "blob", "mat_copperwire", "Copper Wire", 200);
		b.buildOnGround = true;
		b.size.Set(40, 32);
		blocks[2].push_back(b);
	}
	{
		BuildBlock b(0, "plasteelgrinder", "$icon_plasteelgrinder$", "Plasteel Grinder:\n\nA large heavy grinder with mithril saws, which are capable of decompose atoms.");
		AddRequirement(b.reqs, "blob", "mat_mithrilingot", "Mithril Ingot", 50);
		AddRequirement(b.reqs, "blob", "mat_matter", "Amazing Technicolor Dust", 200);
		AddRequirement(b.reqs, "blob", "mat_wilmetingot", "Wilmet Ingot", 40);
		AddRequirement(b.reqs, "blob", "mat_plasteel", "Plasteel Sheet", 300);
	...
	{
		BuildBlock b(0, "plasteelrextractor", "$icon_plasteelrextractor$", "Extractor:\n\nGrabs $blue$filtered$blue$ items from nearby inventories with high speed.");
		AddRequirement(b.reqs, "blob", "mat_plasteel", "Plasteel Sheet", 50);
		AddRequirement(b.reqs, "blob", "mat_mithrilingot", "Mithril Ingot", 10);
		AddRequirement(b.reqs, "blob", "mat_wilmetingot", "Wilmet Ingot", 5);
		b.buildOnGround = true;
		b.size.Set(16, 16);
		blocks[2].push_back(b);
	}
	{
		BuildBlock b(0, "1x5plasteelblastdoor", "$icon_1x5plasteelblastdoor$", "Plasteel Blast Door:\n\nA large heavy blast door, reinforced with plasteel sheets.\n\nCan be only opened by a Security Station.");
		AddRequirement(b.reqs, "blob", "mat_mithrilingot", "Mithril Ingot", 20);
		AddRequirement(b.reqs, "blob", "mat_wilmetingot", "Wilmet Ingot", 10);
		AddRequirement(b.reqs, "blob", "mat_plasteel", "Plasteel Sheet", 200);
