...
void addCommonBuilderBlocks(BuildBlock[][]@ blocks, int teamnum = 7)
{
	...
	AddIconToken("$bedrock_block$", "World.png", Vec2f(8, 8), CMap::tile_bedrock);
	AddIconToken("$ground_back_block$", "World.png", Vec2f(8, 8), CMap::tile_ground_back);
	AddIconToken("$stone_block$", "World.png", Vec2f(8, 8), CMap::tile_stone);
	AddIconToken("$thickstone_block$", "World.png", Vec2f(8, 8), CMap::tile_thickstone);
	AddIconToken("$gold_block$", "World.png", Vec2f(8, 8), CMap::tile_gold);
	AddIconToken("$grass_block$", "World.png", Vec2f(8, 8), CMap::tile_grass);
	...
	AddIconToken("$icon_patreonshop$", "Present.png", Vec2f(32, 24), 0, teamnum);
	...
	}
	{
		...
		blocks[0].push_back(b);
	{
		BuildBlock b(CMap::tile_bedrock, "bedrock", "$bedrock_block$", "Very sus block \n ");
		// AddRequirement(b.reqs, "blob", "mat_ironingot", "Iron Ingots", 15);
		blocks[0].push_back(b);
	}
	{
	...
	{
		BuildBlock b(CMap::tile_stone, "stone", "$stone_block$", "Stone \n ");
		// AddRequirement(b.reqs, "blob", "mat_ironingot", "Iron Ingots", 15);
		blocks[0].push_back(b);
	}
	{
		BuildBlock b(CMap::tile_thickstone, "thickstone", "$thickstone_block$", "Thick stone \n ");
		// AddRequirement(b.reqs, "blob", "mat_ironingot", "Iron Ingots", 15);
		blocks[0].push_back(b);
	}
	{
		BuildBlock b(CMap::tile_gold, "gold_back", "$gold_block$", "Gold \n ");
		// AddRequirement(b.reqs, "blob", "mat_ironingot", "Iron Ingots", 15);
		blocks[0].push_back(b);
	}
	{
		BuildBlock b(CMap::tile_grass, "grass", "$grass_block$", "Grass \n ");
		// AddRequirement(b.reqs, "blob", "mat_ironingot", "Iron Ingots", 15);
		blocks[0].push_back(b);
	}
	{
		BuildBlock b(CMap::tile_ground_back, "ground_back", "$ground_back_block$", "Very sus block \n ");
		// AddRequirement(b.reqs, "blob", "mat_ironingot", "Iron Ingots", 15);
		blocks[0].push_back(b);
	}
	// {
...
/* AUTOMATION XDDDDD
	...
	AUTOMATION XDDDDDDDDDDDDDDDDDDDDDDDDDDD
	*/
