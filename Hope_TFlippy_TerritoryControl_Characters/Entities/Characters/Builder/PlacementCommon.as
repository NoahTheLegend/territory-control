...
bool isBuildableAtPos(CBlob@ this, Vec2f p, TileType buildTile, CBlob @blob, bool &out sameTile)
{
	...
	// tilemap check
	const bool buildSolid = (map.isTileSolid(buildTile) || (buildTile >= 800 && buildTile <= 824) || (blob !is null && blob.isCollidable()) || (buildTile == CMap::tile_iron || buildTile == CMap::tile_glass || buildTile == CMap::tile_titanium
	...
	|| buildTile == CMap::tile_goldingot || buildTile == CMap::tile_mithrilingot || buildTile == CMap::tile_copperingot || buildTile == CMap::tile_steelingot || buildTile == CMap::tile_ironingot || buildTile == CMap::tile_bricks));
...
/*
	...
	else if (((backtile.type >= CMap::tile_glass && backtile.type <= CMap::tile_glass_d0) 																														&& (buildTile == CMap::tile_titanium || buildTile == CMap::tile_bricks || buildTile == CMap::tile_wood || buildTile == CMap::tile_castle || buildTile == CMap::tile_concrete || buildTile == CMap::tile_iron || buildTile == CMap::tile_reinforcedconcrete || buildTile == CMap::tile_plasteel)) ||
			((backtile.type == CMap::tile_wood || (backtile.type >= 200 && backtile.type <= 204)) 																												&& (buildTile == CMap::tile_titanium || buildTile == CMap::tile_castle || buildTile == CMap::tile_concrete || buildTile == CMap::tile_iron || buildTile == CMap::tile_reinforcedconcrete || buildTile == CMap::tile_plasteel)) ||
			((backtile.type == CMap::tile_castle || (backtile.type >= 58 && backtile.type <= 63)) 																												&& (buildTile == CMap::tile_titanium || buildTile == CMap::tile_concrete || buildTile == CMap::tile_iron || buildTile == CMap::tile_reinforcedconcrete || buildTile == CMap::tile_plasteel)) ||
			((backtile.type == CMap::tile_bricks || (backtile.type >= 58 && backtile.type <= 63)) 																												&& (buildTile == CMap::tile_titanium || buildTile == CMap::tile_castle || buildTile == CMap::tile_concrete || buildTile == CMap::tile_iron || buildTile == CMap::tile_reinforcedconcrete || buildTile == CMap::tile_plasteel)) ||
			((backtile.type == CMap::tile_castle_moss || (backtile.type >= 58 && backtile.type <= 63)) 																											&& (buildTile == CMap::tile_titanium || buildTile == CMap::tile_bricks || buildTile == CMap::tile_castle || buildTile == CMap::tile_concrete || buildTile == CMap::tile_iron || buildTile == CMap::tile_reinforcedconcrete || buildTile == CMap::tile_plasteel)) ||
			(((backtile.type >= CMap::tile_concrete && backtile.type <= CMap::tile_concrete_d7) || (backtile.type >= CMap::tile_mossyconcrete && backtile.type <= CMap::tile_mossyconcrete_d4))					&& (buildTile == CMap::tile_titanium || buildTile == CMap::tile_iron || buildTile == CMap::tile_reinforcedconcrete || buildTile == CMap::tile_plasteel)) ||
