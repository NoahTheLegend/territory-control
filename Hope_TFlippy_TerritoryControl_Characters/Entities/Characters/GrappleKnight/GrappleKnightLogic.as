...
void ManageGrapple(CBlob@ this, GrappleKnightInfo@ knight)
{
...
bool checkGrappleStep(CBlob@ this, GrappleKnightInfo@ knight, CMap@ map, const f32 dist)
{
...
bool grappleHitMap(GrappleKnightInfo@ knight, CMap@ map, const f32 dist = 16.0f)
{
...
bool shouldReleaseGrapple(CBlob@ this, GrappleKnightInfo@ knight, CMap@ map)
{
...
void DoAttack(CBlob@ this, f32 damage, f32 aimangle, f32 arcdegrees, u8 type, int deltaInt, GrappleKnightInfo@ info)
{
	if (!getNet().isServer())
	{
		return;
