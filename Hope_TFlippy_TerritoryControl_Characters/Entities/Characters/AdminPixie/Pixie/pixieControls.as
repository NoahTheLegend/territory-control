...
void onTick(CMovement@ this)
{
    ...
    if(b.isKeyJustPressed(key_eat) && !this.getBlob().get_bool("blocked_by_music_mode"))
    {
		b.getSprite().PlaySound("HEY.ogg", 2.0f, 1.0f);
		ShakeScreen(64, 32, b.getPosition());
		b.set_u32("meme", getGameTime() + 15);
		b.set_bool("state", true);
    }
	if((b.get_u32("meme") < getGameTime()) && b.get_bool("state"))
	{
		b.set_bool("state", false);
		b.getSprite().PlaySound("LISTEN.ogg", 2.0f, 1.0f);
	}
