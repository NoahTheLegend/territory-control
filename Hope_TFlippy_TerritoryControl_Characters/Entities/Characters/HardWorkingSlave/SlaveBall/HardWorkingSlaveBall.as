...
void onInit(CBlob@ this)
{
	...
	CSpriteLayer@ chain = sprite.addSpriteLayer("chain", "HardWorkingSlaveBall_Chain.png", 32, 2, this.getTeamNum(), 0);
...
void onTick(CBlob@ this)
{
	...
	if (slave !is null && slave.getName() == "hardworkingslave")
	{		
...
{
	return byBlob.getName() != "hardworkingslave";
}
