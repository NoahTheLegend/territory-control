...
void onInit(CBlob@ this)
{
	...
	Vehicle_SetupWaterSound(this, v, "AAAA",  // movement sound
	                        0.5f, // movement sound volume modifier   0.0f = no manipulation
	                        0.75f // movement sound pitch modifier     0.0f = no manipulation
	                       );
	...
	CSpriteLayer@ front = sprite.addSpriteLayer("front layer", sprite.getConsts().filename, 101, 60);
	if (front !is null)
	{
		front.addAnimation("default", 1, false);
		int[] frames = {1};
