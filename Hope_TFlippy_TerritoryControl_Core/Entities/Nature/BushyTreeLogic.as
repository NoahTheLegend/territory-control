...
void GrowSprite(CSprite@ this, TreeVars@ vars)
{
	...
	string spritePath = getTreeSpritePath();
	...
	for (uint i = 0; i < segments.length; i++)
	{
		...
		if (segment !is null && !segment.gotsprites)
		{
			...
			{
				CSpriteLayer@ newsegment = this.addSpriteLayer("segment " + i, spritePath , 32, 16, 0, 0);
			...
			else if (segment.grown_times == 3 && i > 0 && i != vars.max_height - 1)
			{
				...
				{
					CSpriteLayer@ newsegment = this.addSpriteLayer("leaves " + i + " " + spriteindex, spritePath , 32, 32, 0, 0);
			...
			{
				f32 flipsign = 1.0f;
				CSpriteLayer@ newsegment = this.addSpriteLayer("roots", spritePath , 32, 16, 0, 0);
			...
			{
				CSpriteLayer@ newsegment = this.addSpriteLayer("extra leaves top", spritePath , 32, 32, 0, 0);
			...
			else if (segment.grown_times == 5 && i == vars.max_height - 1) //top of the tree
			{
				...
				{
					CSpriteLayer@ newsegment = this.addSpriteLayer("leaves " + i + " " + 3, spritePath , 64, 32, 0, 0);
				...
				{
					CSpriteLayer@ newsegment = this.addSpriteLayer("leaves " + i + " " + 4, spritePath , 64, 32, 0, 0);
...
string getTreeSpritePath() 
{
	...
	{
		case MapType::arctic:
			return "Mods/territory-control/Hope_TFlippy_TerritoryControl_Core/Gamemode/TexturePacks/Arctic/Arctic_Trees.png";
		case MapType::dead:
			return "Mods/territory-control/Hope_TFlippy_TerritoryControl_Core/Gamemode/TexturePacks/Dead/Dead_Trees.png";
		case MapType::desert:
			return "Mods/territory-control/Hope_TFlippy_TerritoryControl_Core/Gamemode/TexturePacks/Desert/Desert_Trees.png";
		case MapType::jungle:
			return "Mods/territory-control/Hope_TFlippy_TerritoryControl_Core/Gamemode/TexturePacks/Jungle/Jungle_Trees.png";
	}
