...
void GrowSprite(CSprite@ this, TreeVars@ vars)
{
	...
	for (uint i = 0; i < segments.length; i++)
	{
		...
		if (segment !is null && !segment.gotsprites)
		{
			...
			{
				CSpriteLayer@ newsegment = this.addSpriteLayer("segment " + i, spritePath , 16, 16, 0, 0);
			...
			{
				CSpriteLayer@ newsegment = this.addSpriteLayer("leaves " + i, spritePath , 32, 32, 0, 0);
			...
			else if (segment.grown_times == 5)
			{
				...
				{
					bool flip = false;
					CSpriteLayer@ newsegment = this.addSpriteLayer("leaves side " + i, spritePath , 32, 32, 0, 0);
					...
					if (XORRandom(2) == 0)
					{
						CSpriteLayer@ secondnewsegment = this.addSpriteLayer("leaves doubleside " + i, spritePath , 32, 32, 0, 0);
