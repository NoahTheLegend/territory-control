...
class VoteObject
{
	...
	VoteObject()
	{
		...
		timeremaining = 45 * 30; //default 45s
		required_percent = 0.65f; //default 65%
...
void PassVote(VoteObject@ vote)
{
	...
	printf("vote percentage: "+vote.required_percent);
	printf("vote current yes: "+vote.current_yes);
	printf("vote current no: "+vote.current_no);
	printf("voted total: "+(vote.current_no+vote.current_yes));
