...
void onInit(CBlob@ this)
{
	...
	settings.B_SPEED = 30; //Bullet speed, STRONGLY AFFECTED/EFFECTS B_GRAV
	...
	//Sound
	settings.FIRE_SOUND = "FlaregunFire.ogg"; //Sound when shooting
	settings.RELOAD_SOUND = "FlaregunReload.ogg"; //Sound when reloading
	...
	this.set_string("ProjBlob", "flare");
