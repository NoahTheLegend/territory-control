...
void onInit(CBlob@ this)
{
	...
	//General
	settings.CLIP = 26; //Amount of ammunition in the gun at creation
	settings.TOTAL = 26; //Max amount of ammo that can be in a clip
	settings.FIRE_INTERVAL = 0.99; //Time in between shots
	settings.RELOAD_TIME = 48; //Time it takes to reload (in ticks)
	...
	//Recoil
	settings.G_RECOIL = -4; //0 is default, adds recoil aiming up
	...
	//Sound
	settings.FIRE_SOUND = "VectorFire.ogg"; //Sound when shooting
	settings.RELOAD_SOUND = "VectorReload.ogg"; //Sound when reloading
