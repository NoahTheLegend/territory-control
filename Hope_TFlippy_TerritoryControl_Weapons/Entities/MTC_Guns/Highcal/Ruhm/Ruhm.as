...
void onInit(CBlob@ this)
{
	...
	settings.FIRE_INTERVAL = 2.100; //Time in between shots
	...
	settings.B_DAMAGE = 2.100f; //1 is 1 heart
	...
	//Sound
	settings.FIRE_SOUND = "RuhmFire.ogg"; //Sound when shooting
	settings.RELOAD_SOUND = "SniperReload.ogg"; //Sound when reloading

	//Offset
	settings.MUZZLE_OFFSET = Vec2f(-30.5, -1); //Where the muzzle flash appears
