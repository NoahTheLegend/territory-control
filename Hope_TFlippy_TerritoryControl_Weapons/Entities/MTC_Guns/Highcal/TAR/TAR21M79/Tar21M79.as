...
void onInit(CBlob@ this)
{
	...
	settings.FIRE_INTERVAL = 2.5; //Time in between shots
	...
	//Sound
	settings.FIRE_SOUND = "TAR21_Shoot.ogg"; //Sound when shooting
	//settings.RELOAD_SOUND = "SMGReload.ogg"; //Sound when reloading

	//Offset
	settings.MUZZLE_OFFSET = Vec2f(-17, -1.5); //Where the muzzle flash appears
	...
	if (laser !is null)
	{
		...
		laser.SetOffset(Vec2f(-4.5f, 2.0f));
	}
}
