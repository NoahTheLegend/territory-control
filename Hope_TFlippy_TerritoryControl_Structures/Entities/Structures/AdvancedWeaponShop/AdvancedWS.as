...
void onInit(CBlob@ this)
{
	...
	{
		ShopItem@ s = addShopItem(this, "Grenades (2)", "$grenade$", "mat_grenade-2", "Bouncy grenades for grenadelaunchers.");
		AddRequirement(s.requirements, "coin", "", "Coins", 125);

		s.spawnNothing = true;
	}
	{
		ShopItem@ s = addShopItem(this, "Rockets (1)", "$mat_smallrocket$", "mat_smallrocket-1", "Small rocket for rocketlaunchers.");
		AddRequirement(s.requirements, "coin", "", "Coins", 75);
	...
	}
    {
		...
		AddRequirement(s.requirements, "coin", "", "Coins", 2400);
	...
	}
	{
		...
		AddRequirement(s.requirements, "blob", "mat_titaniumingot", "Titanium Ingot", 10);
