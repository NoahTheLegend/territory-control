...
void onInit(CSprite@ this)
{
...

	{
		...
		CSpriteLayer@ gear = this.addSpriteLayer("gear1", "AdvancedAssembler.png" , 16, 16, this.getBlob().getTeamNum(), this.getBlob().getSkinNum());
...

	{
		...
		CSpriteLayer@ gear = this.addSpriteLayer("gear2", "AdvancedAssembler.png" , 16, 16, this.getBlob().getTeamNum(), this.getBlob().getSkinNum());
...

	{
		...
		CSpriteLayer@ gear = this.addSpriteLayer("gear3", "AdvancedAssembler.png" , 16, 16, this.getBlob().getTeamNum(), this.getBlob().getSkinNum());
