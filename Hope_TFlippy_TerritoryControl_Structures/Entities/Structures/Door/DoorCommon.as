...
bool canOpenDoor(CBlob@ this, CBlob@ blob)
{
	...
	if ((blob.getShape().getConsts().collidable) &&
	        ...
	        (this.getTeamNum() == 255 && blob.getTeamNum() < 0 || this.getTeamNum() == 255 && blob.getTeamNum() > 6 || this.getTeamNum() == blob.getTeamNum() || (blob.getTeamNum() >= 100 && blob.getTeamNum() < 200 && lockdown_passable)) &&
