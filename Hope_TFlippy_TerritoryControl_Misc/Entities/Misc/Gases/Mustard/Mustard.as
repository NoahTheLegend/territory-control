...
void onInit(CBlob@ this)
{
	...
	this.getCurrentScript().tickFrequency = 3 + XORRandom(3);
...
void onTick(CBlob@ this)
{
	...
	if (getMap().getBlobsInRadius(this.getPosition(), this.getRadius() * 1.5f, @blobsInRadius))
	{
		...
		for (uint i = 0; i < blobSize; i++)
		{
			...
			if (blob is null || !blob.hasTag("flesh") || blob.hasTag("gas") || (deity_id == Deity::leutnant) || blob.hasTag("gas immune") || !blob.isCollidable())break;
