...
void onInit(CBlob@ this)
{
	...
	this.addCommandID("remove_chute");
...
void GetButtonsFor(CBlob@ this, CBlob@ caller)
{
	...
	else if (caller is this && this.hasTag("parachute")) caller.CreateGenericButton(6, Vec2f(0.0f, 0.0f), this, this.getCommandID("remove_chute"), "Remove parachute.", params);
}
...
void onCommand(CBlob@ this, u8 cmd, CBitStream @params)
{
	...
	{
		this.Tag("parachute");
		this.Untag("remove parachute");
	}
	else if (cmd == this.getCommandID("remove_chute"))
	{
		this.Untag("parachute");
		this.Tag("remove parachute");
		HideParachute(this);
	}
}
