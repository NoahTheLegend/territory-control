...
void onInit(CBlob@ this)
{
	...
	}
	{
		...
		AddRequirement(s.requirements, "blob", "mat_wilmet", "Wilmet", 135);
		s.spawnNothing = true;
	}
	{
	...
	{
		ShopItem@ s = addShopItem(this, "Wilmet", "$mat_wilmet$", "mat_wilmet-20", "Refine 10 Mithril Ore And 10 Gold Ore into 20 wilmet.");
		AddRequirement(s.requirements, "blob", "mat_mithril", "Mithril Ore", 10);
		AddRequirement(s.requirements, "blob", "mat_mithrilingot", "Mithril Ingot", 1);
	...
	{
	    ShopItem@ s = addShopItem(this, "Laser Rifle", "$laserrifle$", "laserrifle", "Automatical rifle with medium damage and firerate.");
